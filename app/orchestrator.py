...
# app/orchestrator.py — runs the agents in order (schema → SQL → execute → critique → presentation).

from typing import Any, TypedDict

from app.agents.data_critic_agent import criticize_results
from app.agents.guardrail_agent import validate_and_execute
from app.agents.metadata_agent import get_schema
from app.agents.presentation_agent import format_presentation
