...
# app/config.py — central place for app configuration (DB paths + API keys).
...
# Project root directory (this file lives under `app/`).
PROJECT_ROOT = Path(__file__).resolve().parent.parent

# --- Database (sales) ---
# Allow override for tests or custom DB locations.
SALES_DB_PATH = Path(os.getenv("SALES_DB_PATH", str(PROJECT_ROOT / "sales.db")))
DATABASE_URL = f"sqlite:///{SALES_DB_PATH.as_posix()}"

# --- Ollama / Local LLM (kept for backwards compatibility) ---
OLLAMA_MODEL = "llama3"
